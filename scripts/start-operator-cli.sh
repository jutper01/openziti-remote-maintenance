...
echo ""
echo "Valid Examples (exec):"
echo "  python $CLI_FILE uname -a"
echo "  python $CLI_FILE ls -la /app"
echo "  python $CLI_FILE echo 'Hello from operator'"
echo ""
echo "Valid Examples (files):"
echo "  python $CLI_FILE upload /tmp/hello.txt /uploaded/hello.txt"
echo "  check with: python $CLI_FILE ls -la /var/local/ops_files/uploaded"
